...
if (isset($_POST['ok']))
{
    ...
    )
    {
        ...
        VALUES (:EMP_ID_bv,:NAME_bv,:NID_bv,to_date('" . $DOB . "','MM/DD/YYYY')
            ,:PERSENT_ADDRESS_bv,:PERMANENT_ADDRESS_bv,:EMAIL_bv,:BLOOD_GROUP_bv,:EDUCATION_bv,:EXPERIENCE_bv
...
echo ' <h1> Table of Employee</h1>';
    $stid = oci_parse($c1, 'SELECT EMP_ID,NAME,NID,DOB,PERSENT_ADDRESS,PERMANENT_ADDRESS,EMAIL
