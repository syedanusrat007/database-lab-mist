...
*/
if($old3 == 'Status')
 { $stid1 = oci_parse($c1, "UPDATE  oldpeople set O_status='$old2' where O_name = INITCAP('$old1')");
 ...
 if($old3 == 'Med_list')
 { $stid1 = oci_parse($c1, "UPDATE  oldpeople set O_medicine_list='$old2' where O_name = INITCAP('$old1')");
    ...
    if($old3 == 'Diease')
 { $stid1 = oci_parse($c1, "UPDATE  oldpeople set O_diease='$old2' where O_name = INITCAP('$old1')");
