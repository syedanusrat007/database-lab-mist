...
<form action="medupdate.php" method="POST">
...
*/
if($med3 == 'Quantity')
 { $stid1 = oci_parse($c1, "UPDATE  medicine set med_quantity='$med2' where med_name = ('$med1')");
 ...
 if($med3 == 'Cost')
 { $stid1 = oci_parse($c1, "UPDATE  medicine set med_cost ='$med2' where med_name = ('$med1')");
    ...
    if($med3 == 'BD')
 { $stid1 = oci_parse($c1, "UPDATE  medicine set med_date ='$med2' where med_name = ('$med1')");
