...
<url>
  ...
  <h1>Insertion In Food Table </h1>
   <div class="login" align="center">
   <form action="foodinsert.php"  method="POST">

    
    <input type="text" name="Day" id="email" placeholder="Day" required><br><br>
    <input type="text" name="Type" id="email" placeholder="Type" required><br><br>
    <input type="text" name="Cost" id="password" placeholder="Cost" required><br><br>
     <input type="text" name="Menu" id="password" placeholder="Menu" required><br><br>
    <input type="date" name="BD" id="email" placeholder="Date" required><br><br>
    <input type="text" name="Period" id="email" placeholder="Period" required><br><br>
