...
<url>
   ...
   <form action="O_insert.php"  method="POST">
    ...
    <input type="date" name="BD" id="email" placeholder="DOB" required><br><br>
    <input type="text" name="Address" id="email" placeholder="Address" required><br><br>
  <input type="text" name="Phone" id="email" placeholder="Phone" required><br><br>
    <tr>
           <div class="p">
            Blood Group 
  ...
  <input type="date" name="Day" id="email" placeholder="Joining Date" required><br><br>
    <input type="text" name="EDUCATION" id="email" placeholder="EDUCATION" required><br><br>
    <input type="text" name="Hobby" id="email" placeholder="Hobby" required><br><br>
     
    <input type="text" name="Med_list" id="email" placeholder="Med_list" required><br><br>
    <input type="text" name="Diease" id="email" placeholder="Diease" required><br><br>
   <input type="text" name="Relogion" id="email" placeholder="Relogion" required><br><br>
    <input type="text" name="O_food_restriction" id="email" placeholder="Food Restriction" required><br><br>
    <input type="text" name="Status" id="email" placeholder="Status" required><br><br>
